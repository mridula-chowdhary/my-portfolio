...
const CodingProfile = () => {
  return (
    <section id="coding-profile" className=" relative z-10 text-white rounded-lg shadow-lg max-w-4xl mx-auto mt-12 mb-12">
      <h2 className="text-4xl md:text-5xl mb-8 text-center font-semibold">Profile</h2>
      <p className="text-center text-lg md:text-xl mb-8">Check out my profiles on these coding platforms:</p>
